...
public class VistaGestionUsuarios extends JPanel implements IVistaGestionUsuarios {
    ...
    public void setPresenter(UsuarioPresenter presenter) {
        ...
        // 2. Conexión de la Tabla (Para poder editar un usuario al hacerle clic)
    ...
    public void limpiarCampos() {
        ...
        grillaUsuarios.clearSelection(); // Deselecciona la tabla también
    }
    ...
    // Opcional: Para que el presentador pueda setear los datos cuando haces clic en la tabla
    ...
    private void aplicarEstilo() {
        ...
        pnlDerechoWrapper.setBackground(C_FONDO); 
    ...
    private void initComponents() {
        ...
        pnlFormulario.add(lblUsername, gf);
        gf.gridy = r++;
        gf.insets = new Insets(0, 0, 25, 0);
        pnlFormulario.add(txtUsername, gf);

        gf.gridy = r++;
        gf.insets = new Insets(0, 0, 6, 0);
        pnlFormulario.add(lblPassword, gf);
        gf.gridy = r++;
        gf.insets = new Insets(0, 0, 25, 0);
        pnlFormulario.add(txtPassword, gf);

        gf.gridy = r++;
        gf.insets = new Insets(0, 0, 6, 0);
        pnlFormulario.add(lblRol, gf);
        gf.gridy = r++;
        gf.insets = new Insets(0, 0, 35, 0);
        pnlFormulario.add(cbxRol, gf);
