...
public class VistaMedicos extends JPanel implements IVistaMedicos {
    ...
    public void setControlador(java.awt.event.ActionListener presentador) {
        ...
        btnGuardarMedico.setActionCommand(BTN_GUARDAR_MEDICO);
        btnGuardarMedico.addActionListener(presentador);
        
        btnEliminarMedico.setActionCommand(BTN_ELIMINAR_MEDICO);
        btnEliminarMedico.addActionListener(presentador);
        
        btnVolver.setActionCommand(BTN_VOLVER);
        btnVolver.addActionListener(presentador);

        // ── MAGIA MVP: Convertimos las teclas en un evento genérico ──
        txtBuscarMedico.addKeyListener(new java.awt.event.KeyAdapter() {
            @Override 
            public void keyReleased(java.awt.event.KeyEvent evt) {
                if (presentador != null) {
                    // Disparamos un ActionEvent falso con el comando "BUSCAR_MEDICO"
                    presentador.actionPerformed(new java.awt.event.ActionEvent(txtBuscarMedico, java.awt.event.ActionEvent.ACTION_PERFORMED, "BUSCAR_MEDICO"));
                }
            }
        });

        // ── MAGIA MVP: Convertimos el clic del mouse en un evento genérico ──
        grillaMedicos.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override 
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (presentador != null) {
                    // Disparamos un ActionEvent falso con el comando "SELECCIONAR_MEDICO"
                    presentador.actionPerformed(new java.awt.event.ActionEvent(grillaMedicos, java.awt.event.ActionEvent.ACTION_PERFORMED, "SELECCIONAR_MEDICO"));
                }
            }
        });
    }
