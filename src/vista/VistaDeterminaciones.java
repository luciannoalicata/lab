...
public class VistaDeterminaciones extends javax.swing.JDialog implements IVistaDeterminaciones {
    ...
    // Paleta institucional coherente con el sistema
    ...
    private final Color COLOR_CAMPO        = new Color(240, 250, 255);
    ...
    public VistaDeterminaciones(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        txtDeterminacion.addActionListener(e -> {
            if (ventanaSugerencias != null && ventanaSugerencias.isVisible() && !listaSugerencias.isSelectionEmpty()) {
    ...
    private void configurarEsteticaPersonalizada() {
        ...
        lblTitulo.setText("AGREGAR PRÁCTICA — CÓDIGO O NOMBRE");
        ...
        // Columna CÓDIGO: angosta y centrada
        ...
        // Columna DETERMINACIÓN: ocupa el resto
        grillaDeterminaciones.getColumnModel().getColumn(1).setPreferredWidth(600);

        // Renderizador para la columna CÓDIGO (Columna 0)
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(javax.swing.JTable t,
                ...
                String nombreFila = t.getModel().getValueAt(row, 1) != null ? t.getModel().getValueAt(row, 1).toString() : "";
                boolean esSubtitulo = nombreFila.startsWith("---") && nombreFila.endsWith("---");

                if (esSubtitulo) {
                    setText(""); // Ocultamos el código para que quede limpio el divisor
                    setBackground(new Color(235, 242, 248)); // Fondo azul suave
                    setBorder(BorderFactory.createMatteBorder(1, 4, 1, 0, COLOR_AZUL_MEDIO)); // Franja lateral izquierda
                } else {
                    setHorizontalAlignment(SwingConstants.CENTER);
                    setFont(new Font("Segoe UI", Font.PLAIN, 13));
                    if (!sel) {
                        setBackground(row % 2 == 0 ? COLOR_BLANCO : COLOR_FILA_PAR);
                        setForeground(COLOR_TEXTO_LABEL);
                    } else {
                        setBackground(new Color(210, 232, 250));
                        setForeground(COLOR_AZUL_OSCURO);
                    }
                }
                return this;
            }
        ...
        // Renderizador para la columna DETERMINACIÓN (Columna 1)
        DefaultTableCellRenderer leftRenderer = new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(javax.swing.JTable t,
                ...
                if (esSubtitulo) {
                    // ── LA MAGIA: Borramos los guiones solo visualmente ──
                    ...
                    // Fila normal, dejamos el texto intacto
                    setText(nombreFila);
        ...
        grillaDeterminaciones.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        grillaDeterminaciones.getColumnModel().getColumn(1).setCellRenderer(leftRenderer);
    ...
    public void cargarTablaConTitulos(List<Determinacion> lista) {
        ...
        model.setRowCount(0); // Vaciamos la tabla por completo
        
        for (Determinacion d : lista) {
            // Si es un título virtual, pasamos un código vacío para que el renderizador lo pinte bien
    ...
    private void configurarBuscadorDeterminaciones() {
        ...
        txtDeterminacion.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (ventanaSugerencias != null && ventanaSugerencias.isVisible() && !modeloSugerencias.isEmpty()) {
                    ...
                    switch (e.getKeyCode()) {
                        ...
                        case KeyEvent.VK_ESCAPE:
                            ventanaSugerencias.setVisible(false); break;
                    }
                }
            }
            @Override
            public void keyReleased(KeyEvent e) {
                ...
                if (texto.length() >= 1) controlador.buscarSugerenciasDeterminacion(texto);
                else if (ventanaSugerencias != null) ventanaSugerencias.setVisible(false);
            }
        });
    ...
    private void seleccionarSugerencia() {
        ...
        if (seleccion != null) {
            ...
            txtDeterminacion.setText(codigo);
            if (ventanaSugerencias != null) ventanaSugerencias.setVisible(false);
            btnAgregarDeterminacion.doClick();
        }
    }
    ...
    public void mostrarSugerencias(List<Determinacion> sugerencias) {
        ...
        java.awt.Point p = txtDeterminacion.getLocationOnScreen();
        ventanaSugerencias.setBounds(p.x, p.y + txtDeterminacion.getHeight(),
            txtDeterminacion.getWidth(), Math.min(200, sugerencias.size() * 30 + 5));
    ...
    public void setControlador(Controlador control) {
        ...
        btnAgregarDeterminacion.setActionCommand(BTN_AGREGAR_DETERMINACION);
        btnAgregarDeterminacion.addActionListener(control);
        btnEliminar.setActionCommand(BTN_ELIMINAR);
        btnEliminar.addActionListener(control);
        btnContinuar.setActionCommand(BTN_CONTINUAR);
    ...
    @Override public int    getFilaSeleccionada()        { return grillaDeterminaciones.getSelectedRow(); }
    ...
    private void initComponents() {
        ...
        pnlHeader.setPreferredSize(new Dimension(900, 75));
        pnlHeader.setBorder(new EmptyBorder(10, 25, 10, 25));

        // Label titulo pequeño (fila 0)
        ...
        // Panel izquierdo: Continuar
        javax.swing.JPanel pnlLeft = new javax.swing.JPanel(
            new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 20, 17));
        pnlLeft.setOpaque(false);
        pnlLeft.add(btnContinuar);

        // Panel derecho: Eliminar
        javax.swing.JPanel pnlRight = new javax.swing.JPanel(
            new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT, 20, 17));
